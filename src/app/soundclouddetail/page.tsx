...
function Clouddetail() {
  ...
  return (
    <div>
      <Header />
      <section>
        <div className="banner-top insta-bnr cloud-right no-image">
          <Image
            className="banar-bk"
          ...
          <div className="container">
            <h2>
              ...
              <Image
                ...
                alt=""
              />
              שירותי הקידום <span>בסאונד קלאוד</span>
            </h2>
            <p dir="rtl">
              העוקבים הלייקים הצפיות מגיעים ממשתמשים אמיתיים מחו"ל. התשלום חד
              פעמי, מאובטח לגמרי והרכישה דיסקרטית לחלוטין - שמות הלקוחות מוצפנים
              ולעולם לא ייחשפו.
            </p>
          </div>
        </div>
      </section>
      <section className="buyer-tab spund-cloud-buy">
        <div className="container">

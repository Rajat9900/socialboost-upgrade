                ...
                <div className="right-insta-detial cloud-right">
                  <h2>
                    ...
                    <Image
                      ...
                      alt=""
                    />
                    שירותי הקידום בסאונד קלאוד<span>קלאוד</span>
                  </h2>
                  <p dir="rtl">
                    העוקבים הלייקים הצפיות מגיעים ממשתמשים אמיתיים מחו"ל. התשלום
                    חד פעמי, מאובטח לגמרי והרכישה דיסקרטית לחלוטין - שמות
              ...
              <div className="col-md-6">
                <div className="about-inner">
                  ...
                  <p dir="rtl">
                    ...
                    האשראי נשמרים דיסקרטיים לחלוטין. בנוסף אנחנו לעולם לא נבקש
                    את הסיסמא לחשבון האינסטגרם שלך!
                  </p>
                </div>
              </div>
              <div className="col-md-6">

      ...
      <section>
        <div className="banner-top contact-banner">
          <div className="container">
            <h2>לְהִתְקַשֵׁר</h2>
            <p>
              אם יש לך שאלה כלשהי לגבי שירותי הצמיחה שלנו במדיה החברתית, אנא שלח
              לנו הודעה למטה
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="left-form">
                <h2>
                  ביחד <span>בואו נעבוד</span>
                </h2>
                <p>
                  אנא שתף ​​אותנו בשאילתתך כעת. אנא צור איתנו קשר אם יש לך בעיה
                  כלשהי עם המדיה החברתית שלך
                </p>
                <ul>
                  <li>
                    <span>

    ...
    <div>
      ...
      <section className="tetxo facebook-pack">
        <div className="container">
          ...
          <h5>אז מה המטרות של הגדלת כמות הצפיות ביוטיוב?</h5>
          <div className="row">
            <div className="col-md-4">
              <div className="tetxo-inner">
                <Image
                  ...
                  alt=""
                />
                <h3>יוצרים מהרגע הראשון תדמית של עסק מצליח</h3>
                <p>
            ...
            <div className="col-md-4">
              <div className="tetxo-inner">
                <Image
                  ...
                  alt=""
                />
                <h3>קוראים את המפה העסקית: מדוע חשוב להשקיע בפייסבוק?</h3>
                <p>
            ...
            <div className="col-md-4">
              <div className="tetxo-inner">
                <Image
                  ...
                  alt=""
                />
                <h3>קניית הלייקים: מה המשמעות ואיך היא מתבצעת?</h3>
                <p>
                  באתר Social Boost תוכלו לרכוש את כמות העוקבים או לבצע קניית
                  לייקים לאינסטגרם בכמות הרצויה. בהמשך יהיה עליכם לקשר את הקנייה
                  לחשבון האינסטגרם שלכם, לבצע רכישה על ידי כרטיס האשראי והעוקבים

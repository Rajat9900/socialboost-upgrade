                        ...
                        <div className="col-md-6">
                            <div className="payemnt-left">
                                ...
                                <div className="paybtn">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">שלם עכשיו</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6">
...
<Image
            ...
            <div className="payemt-cards">
              <h5>סיכום הזמנה</h5>
              <ul>
                <li><span>300</span> כמות לייקים :</li>
                 <li><span>10.8 </span>סה"כ לתשלום :</li>
                  <li><span></span>התשלום חד פעמי</li>
                   <li><span></span> <div className="form-check">
  ...
  <label className="form-check-label" htmlFor="flexCheckDefault">
   אני מאשר את התקנון.
            ...
            <div className="all-pay-link">
              <p><a href="#">? לחץ כאן .</a> קוד קופון</p>
              <a className="email-btn" href="#">youremail@example.com <Image
                                                    className="banar-bk"
                                                    ...
                                                    alt=""
                                                  /></a>
              <a className="pay-btn" href="#"><Image
                                                    className="banar-bk"
              ...
              <a className="payment-btn" href="#"><Image
                                                    className="banar-bk"
                                                    src="/assets/images/email-whit.png"
                                                    width={20}
                                                    height={20}
